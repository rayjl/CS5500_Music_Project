 ...
 * Dynamic Programming
 * 
 * This class will be used with AudioMatching.java
 * using FingerPrint objects to determine the longest common
 * subsequence.
 */
...
public class LCS {
    ...
    public static int[] lcs(List<FingerPrint> l1, List<FingerPrint> l2) {
        ...
        // Iterate through and fill table with LCS logic
        ...
        // Load results into an array to return
        int[] answer = new int[3];
        
        // bin offset for file 1
        answer[0] = index1;
        
        // bin offset for file 2
        answer[1] = index2;
        
        // number of bins matched
